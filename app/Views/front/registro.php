...
<div class="container d-flex justify-content-center">
    ...
    <div class="alert alert-dark"> <?=$error = $validation->getError('email');?> </div>
    <?=csrf_field();?>
    ...
    <div class="alert alert-dark"><?=$error = $validation->getError('usuario');?></div>
    <?=csrf_field();?>
    ...
    <div class="alert alert-dark"><?=$error = $validation->getError('password');?></div>
    <?=csrf_field();?>
    ...
    <div class="alert alert-dark"><?=$error = $validation->getError('confirmar');?></div>
    <?=csrf_field();?>
    <div class="buttons">
